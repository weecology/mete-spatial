...
dat1 = dat[dat$x<140,]  ## the 140 x 140 square
dat2 = dat[dat$x>=140 & dat$y<240,]  ## one of the 200 x 100 m rectangles
dat3 = dat[dat$x>=140 & dat$y>=240,] ## the other 200 x 100 m rectangle
