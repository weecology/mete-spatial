...
comms1 = makeCommMat(dat1$spnum,S,cbind(dat1$x,dat1$y),quadLen,quadN,
                     c(140,240,240,440))
write.csv(comms1,file='/home/danmcglinn/maxent/spat/data/sherman1_comms.csv',row.names=F)
## work with dat2 now
...
comms2 = makeCommMat(dat2$spnum,S,cbind(dat2$x,dat2$y),quadLen,quadN,
                     c(140,240,40,240))
write.csv(comms2,file='/home/danmcglinn/maxent/spat/data/sherman2_comms.csv',row.names=F)
...
comms3 = makeCommMat(dat3$spnum,S,cbind(dat3$x,dat3$y),quadLen,quadN,
                     c(0,140,0,140))
write.csv(comms3,file='/home/danmcglinn/maxent/spat/data/sherman3_comms.csv',row.names=F)
